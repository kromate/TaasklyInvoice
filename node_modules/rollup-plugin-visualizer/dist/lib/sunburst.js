var drawChart = (function (exports) {
  ...
  const Tooltip = ({ node, root, sizeProperty }) => {
      ...
      const content = F(() => {
          ...
          return (e$1(p$1, { children: [e$1("div", Object.assign({ className: "details-name" }, { children: node.data.name })), e$1("div", Object.assign({ className: "details-percentage" }, { children: percentageString })), availableSizeProperties.map((sizeProp) => {
                      if (sizeProp === sizeProperty) {
                          return (e$1("div", Object.assign({ className: "details-size" }, { children: e$1("b", { children: [LABELS[sizeProp], ": ", format_1(getModuleSize(node.data, sizeProp))] }) })));
                      }
                      else {
                          return (e$1("div", Object.assign({ className: "details-size" }, { children: [LABELS[sizeProp], ": ", format_1(getModuleSize(node.data, sizeProp))] })));
                      }
                  })] }));
      }, [availableSizeProperties, getModuleSize, node, root.data, sizeProperty]);
      return e$1("div", Object.assign({ className: "details" }, { children: content }));
  };
  ...
  const Node = ({ node, onMouseOver, onClick, path, highlighted, selected }) => {
      return (e$1("path", { d: path, "fill-rule": "evenodd", stroke: "#fff", fill: colorDefault(node), onMouseOver: (evt) => {
              evt.stopPropagation();
              onMouseOver(node);
          }, onClick: (evt) => {
              evt.stopPropagation();
  ...
  const SunBurst = ({ root, onNodeHover, isNodeHighlighted, selectedNode, onNodeClick, }) => {
      ...
      return (e$1("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: `0 0 ${size} ${size}` }, { children: e$1("g", Object.assign({ transform: `translate(${radius},${radius})` }, { children: root.descendants().map((node) => {
                  return (e$1(Node, { node: node, onMouseOver: onNodeHover, path: arc(node), highlighted: isNodeHighlighted(node), selected: selectedNode === node, onClick: onNodeClick }, getModuleIds(node.data).nodeUid.id));
              }) })) })));
  };
  ...
  const Chart = ({ root, sizeProperty, selectedNode, setSelectedNode }) => {
      ...
      return (e$1(p$1, { children: [e$1(SunBurst, { root: root, onNodeHover: (node) => {
                      setTooltipNode(node);
                  }, isNodeHighlighted: isNodeHighlighted, selectedNode: selectedNode, onNodeClick: (node) => {
                      setSelectedNode(selectedNode === node ? undefined : node);
                  } }), e$1(Tooltip, { node: tooltipNode, root: root, sizeProperty: sizeProperty })] }));
  };
