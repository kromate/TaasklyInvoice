import { r as resolve, n as normalize, a as relative } from './index3.mjs';
...
import { w as withTrailingSlash } from './index4.mjs';
import { s as showBanner } from './banner.mjs';
...
const dev = defineNuxtCommand({
  ...
  async invoke(args) {
    ...
    const { listen } = await import('./index7.mjs');
    let currentHandler;
